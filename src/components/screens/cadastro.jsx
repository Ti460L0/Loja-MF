...
const Cadastro = () => {
  ...
  return (
    <div>
      <h1>Menu</h1>
      <ul>
        <li><button onClick={() => changeScreen('cliente')}>Cadastrar cliente</button></li>
        <li><button onClick={() => changeScreen('vestido')}>Cadastrar vestido</button></li>
      </ul>
      <div>
        {renderForm()}  {/* Renderiza o formulário com base no estado 'screen' */}
      </div>
    </div>
  );
}
